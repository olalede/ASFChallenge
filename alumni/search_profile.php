<?php include 'validations/authentication.php' ?>   
<?php include 'validations/validate_session.php' ?>
<?php include 'functions/jadwiga/headFunc.php' ?>
...
<?php
    if($_POST){
        $query=$_POST['search-form'];
        $sql=mysqli_query($database,"select * from user where user_firstname like '%$query%' or user_lastname like '%$query%' or user_graduate like '%$query%' or user_major like '%$query' order by user_id");
...
?>
 ...
 <div id="panel-element-<?php echo $rws['user_id']; ?>" class="panel-collapse collapse in">
  ...
  <img src="alumniFiles/avatars/<?php echo $rws['user_avatar'];?>" name="aboutme" class="img-responsive">                                  
 </div>


  <div class="col-md-6 column">
    <div class="col-md-12 column">
  <h2><span><?php echo $rws['user_firstname'];?> <?php echo $rws['user_lastname'];?><?php echo $rws['user_graduate'];?><?php echo $rws['user_major'];?></span></h2>
