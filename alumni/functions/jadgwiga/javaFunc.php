  ...
  <script src="assets/js/base/jquery.min.js"></script>
        ...
        $(document).ready(function() {
            $("#user_username").keyup(function (e) {
                ...
                if(username.length >= 1){
                    ...
                    $.post('validations/validate_username.php', {'user_username':username}, function(data) {
                      $("#status").html(data);
                    });
                }
            });	
    ...
    <script type="text/javascript"> 
        ...
        function ChangeIt() {
            ...
            document.body.background = 'assets/img/backgrounds/background1'+num+'.jpg';
        ...
        $(document).ready(function(){
            $(".search").keyup(function() {
                ...
                if(searchbox==''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "validations/validate_search.php",
                        data: dataString,
                        cache: false,
