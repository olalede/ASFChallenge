...
if(isset($_POST['submit']))
{
	...
	$uemail = mysqli_real_escape_string($database, $uemail);
	...
	if(checkUser($uemail) == "true")
	{
		...
		$query = mysqli_query($database, "INSERT INTO recovery_keys (userID, token) VALUES ($userID, '$token') ");
		if($query)
		{
...
<br>
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    ...
    <h6>Welcome Alumni <span class="w3-tag">Forgot password?</span></h6>
...
<br>
        ...
        <label class="col-md-4 control-label">Forgot Password?</label>  
     </div>
